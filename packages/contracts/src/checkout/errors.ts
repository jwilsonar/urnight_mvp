export const CHECKOUT_ERROR_CODES = {
  ...
  INSUFFICIENT_CAPACITY: 'checkout/insufficient-capacity',
  HOLD_NOT_FOUND: 'checkout/hold-not-found',
  HOLD_EXPIRED: 'checkout/hold-expired',
  HOLD_UNAVAILABLE: 'checkout/hold-unavailable',
