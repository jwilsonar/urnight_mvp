...
export function CartaItemDialog({
  ...
  const [pendingItem, setPendingItem] = useState<CartaItemDemo | null>(null);
  ...
  return (
    <>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setForm((f) => ({
                      ...f,
                      priceSoles: Number(e.target.value),
                    }))
                  }
                  placeholder="0.00"
                />
      ...
      <ConfirmDialog
        ...
        destructive={false}
        title={initial ? '¿Guardar cambios del producto?' : '¿Crear este producto?'}
        description={
          initial
            ? 'Revisa los datos antes de aplicar los cambios a la carta.'
            : 'Confirma que deseas agregar este producto a la carta.'
        }
        confirmLabel={initial ? 'Guardar cambios' : 'Crear producto'}
        onConfirm={() => {
