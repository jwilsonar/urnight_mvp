...
const ACCEPT: Accept = Object.fromEntries(ACCEPTED_IMAGE_TYPES.map((t) => [t, []]));
 ...
 */
export function MediaDropzone({ onAccepted, disabled, maxFiles }: MediaDropzoneProps) {
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground">JPG, PNG o WebP · máx {MAX_MB} MB c/u</p>
    </div>
  );
}
