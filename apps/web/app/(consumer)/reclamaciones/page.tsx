  ...
  if (sent) {
    return (
      <div className="mx-auto max-w-xl px-4 py-20 text-center sm:px-6">
        ...
        <h1 className="font-heading text-3xl font-extrabold tracking-tight">Hoja registrada</h1>
        <p className="mt-3 leading-relaxed text-muted-foreground">
          Tu {tipo} quedó registrado con el código{' '}
          <strong className="text-foreground">LR-2026-000123</strong>. Recibirás respuesta en un
          máximo de 15 días hábiles al correo indicado.
        </p>
        <div className="mt-4">
          <Badge variant="info">Demo — el registro real llega con el backend de soporte</Badge>
        </div>
      </div>
    );
  }
      ...
      <form onSubmit={submit} className="mt-9 space-y-5 rounded-lg border bg-card p-6">
        <div className="grid gap-5 sm:grid-cols-2">
          <div className="flex flex-col gap-2">
            ...
            <Select value={tipo} onValueChange={setTipo}>
              ...
              <SelectContent>
                <SelectItem value="reclamo">Reclamo (producto o servicio)</SelectItem>
                <SelectItem value="queja">Queja (atención al cliente)</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="flex flex-col gap-2">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input id="lr-email" type="email" required placeholder="tu@correo.com" />
          </div>
        </div>
        <div className="flex flex-col gap-2">
