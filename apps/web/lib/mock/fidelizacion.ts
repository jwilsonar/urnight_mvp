...
export const BADGES_DEMO: BadgeDemo[] = [
  ...
  { nombre: 'Cumpleaños RAVENUE', sub: 'Celebra tu cumple con nosotros', unlocked: false, icono: '🎂' },
  ...
  { nombre: 'Conexión Lima', sub: 'Trae 10 amigos a RAVENUE', unlocked: false, icono: '🤝' },
