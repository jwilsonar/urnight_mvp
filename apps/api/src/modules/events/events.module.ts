...
import { TrendingConfigProvider } from "./application/config/trending-config.provider";
...
import { TRENDING_CONFIG } from "./domain/ports/trending-config.port";
...
@Module({
  ...
  providers: [
    ...
    { provide: TRENDING_CONFIG, useClass: TrendingConfigProvider },
