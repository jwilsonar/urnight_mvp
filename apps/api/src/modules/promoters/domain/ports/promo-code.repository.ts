...
export interface PromoOrderAttribution {
  promoCodeId: string;
...
export interface PromoCodeRepository {
  ...
  /** Promotor del código efectivamente canjeado por una orden pagada. */
  findAttributionByOrder(
    orderId: string,
   ...
   */
  deactivateUnredeemedByPromoterEvent(
    promoterEventId: string,
    tx?: unknown,
  ): Promise<void>;
