...
@Module({
  ...
  providers: [
    ...
    {
      provide: REFERRAL_LINK_REPOSITORY,
      useClass: DrizzleReferralLinkRepository,
    },
    ...
    {
      provide: SALE_ATTRIBUTION_REPOSITORY,
      useClass: DrizzleSaleAttributionRepository,
    },
    {
      provide: PROMOTER_APPLICATION_REPOSITORY,
      useClass: DrizzlePromoterApplicationRepository,
    },
  ],
