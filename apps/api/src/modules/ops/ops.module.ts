...
@Module({
  ...
  providers: [
    ...
    { provide: PLATFORM_SETTING_REPOSITORY, useClass: DrizzlePlatformSettingRepository },
    ...
    { provide: ANALYTICS_EVENT_REPOSITORY, useClass: DrizzleAnalyticsEventRepository },
