/** Login nativo (SD-02): email+contraseña contra POST /auth/login, espejo del web login. */
...
function messageOf(err: unknown): string {
  ...
  return 'No pudimos conectar con Ravenue. Revisa tu conexión.';
}
      ...
      >
        ...
        >
          <View style={styles.header}>
            <Eyebrow>Acceso · Vida nocturna</Eyebrow>
            <Text style={styles.title}>¡RAVENUE te da la bienvenida!</Text>
          ...
          <View style={styles.form}>
            ...
            <Text style={styles.footer}>
              ¿No tienes cuenta? Regístrate en la web de Ravenue.
            </Text>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
