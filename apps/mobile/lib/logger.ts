/**
 * Logger ligero de la app (Expo / React Native). `pino` no corre bien en RN, así
 * que envolvemos `console` manteniendo la misma firma `(fields, msg)` que el
 * resto del monorepo (§6). Redacta secretos (QR, tokens, documento) por clave.
 */
